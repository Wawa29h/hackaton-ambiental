    ...
    <div ref={containerRef} style={{ display: 'flex', flexDirection: 'row', height: '100vh', background: '#0a0f1e', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, minWidth: 0, position: 'relative' }}>
            ...
            >
              <Popup>
                <div style={{
                  ...
                  <div style={{ marginTop: 8, paddingTop: 6, borderTop: '1px solid rgba(148,163,184,0.15)', fontSize: 10, color: '#b0bec5', fontStyle: 'italic' }}>
                    {zona.descripcion}
                  </div>
                  <button
        ...
        <div style={{
          ...
          fontSize: 11, fontFamily: 'monospace', color: '#b0bec5',
        }}>
        ...
        <div style={{
          ...
          <p style={{ margin: '0 0 8px', fontSize: 9, fontWeight: 700, letterSpacing: 2, color: '#34d399', textTransform: 'uppercase' }}>
            Riesgo de Blanqueamiento
          </p>
          {Object.entries(STATUS_LABELS).map(([key, label]) => (
            <div key={key} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 11, color: '#e2e8f0', marginBottom: 5 }}>
              <span style={{
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 6, paddingTop: 6 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 11, color: '#e2e8f0' }}>
              <span style={{
                width: 10, height: 10, borderRadius: '50%',
            ...
            <div style={{ position: 'relative', flex: 1, minHeight: 0 }}>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: 12 }}>
                  <div style={{ fontSize: 11, color: '#94a3b8', marginBottom: 2 }}>{zonaActiva.pais}</div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 8, marginBottom: 12 }}>
                  {[
                    ...
                    <div key={m.label} style={{
                      ...
                      <div style={{ fontSize: 9, color: '#cbd5e1', letterSpacing: 1, marginBottom: 4 }}>{m.label}</div>
                ...
                <div style={{ marginBottom: 10 }}>
                  <div style={{ fontSize: 9, color: '#cbd5e1', letterSpacing: 1.5, marginBottom: 6 }}>ESPECIES DOMINANTES</div>
            ...
            <>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    {pescaActiva.fecha && <span style={{ fontSize: 10, color: '#94a3b8' }}>{pescaActiva.fecha}</span>}
                  </div>
                </div>
                <button onClick={() => setPescaActiva(null)} style={{
                  background: 'transparent', border: '1px solid rgba(255,255,255,0.1)',
                  color: '#b0bec5', borderRadius: 4, padding: '4px 10px', cursor: 'pointer', fontSize: 12,
                }}>✕</button>
              </div>
              ...
              <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 10, color: '#94a3b8', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 1 }}>Estado del arrecife</div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  {[
                    ...
                    <div key={label} style={{
                      ...
                      <div style={{ fontSize: 10, color: '#94a3b8', marginBottom: 3 }}>{icon} {label}</div>
